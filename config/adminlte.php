...
return [
    ...
    */
    ...
    'logo' => '<b>Convenios</b> HU',
    'logo_img' => 'vendor/adminlte/dist/img/hulogo.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/hulogo.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon' => 'fas fa-fw fa-solid fa-copy',
            'active' => ['admin/contratos*'],
            'can' => 'admin.contratos.index'
        ],
        [
            'text' => 'Lista de Adendas',
            'route' => 'admin.adendas.index',
            'icon' => 'fas fa-fw fa-solid fa-copy',
            'active' => ['admin/adendas*'],
            'can' => 'admin.adendas.index'
        ],
        [
            'text' => 'Lista de Prórrogas',
            'route' => 'admin.prorrogas.index',
            'icon' => 'fas fa-fw fa-solid fa-copy',
            'active' => ['admin/prorrogas*'],
            'can' => 'admin.prorrogas.index'
        ],
        [
            'text' => 'Crear nuevo Documento',
            'route' => 'admin.contratos.create',
            'icon' => 'fas fa-fw fa-solid fa-folder-plus',
            'can' => 'admin.contratos.create'
        ],
        [
            'text' => 'Documentos a vencer',
            'route' => 'admin.vencimientos.index',
            'icon' => 'fas fa-fw fa-solid fa-folder-minus',
            'can' => 'admin.vencimientos.index'
        ],
